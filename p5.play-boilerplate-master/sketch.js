...
gym = loadAnimation("Astronaut's daily routine 2 /gym1.png","gym2.png","gym11.png","gym12.png" );
sleep = loadImage ("Astronaut's daily routine 2 /sleep.png" );
bath = loadAnimation ("Astronaut's daily routine 2 /bath1.png","bath2.png" );
brush = loadImage ("Astronaut's daily routine 2 /brush.png" );
move = loadAnimation ( "Astronaut's daily routine 2 /move.png","move1.png" );
}
